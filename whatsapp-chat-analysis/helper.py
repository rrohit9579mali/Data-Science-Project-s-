...
# 🔥 FIXED: Interest Over Time Logic
def interest_over_time(df, person_name):
    df['temp_month'] = df['date'].dt.to_period('M')
    # Grouping and calculating ratio exactly as you intended
...
# 🔥 FIXED: Added missing interest_factors function
...
# ❤️ Your Original Interest Calculation Logic (Untouched)
